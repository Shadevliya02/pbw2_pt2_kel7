...
<html lang="en">
  <head>
    ...
    <!-- Custom style -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('src/style.css')); ?>" />
    <!-- Icon -->
  ...
  <body>
    <header class="header-la-page">
      <nav>
          <div>
            <a href="<?php echo e(url('landing_page.html')); ?>">
              <img src="<?php echo e(asset('src/img/logo.png')); ?>" class="logo" alt="Telkozy" />
            </a>
            </div>
          ...
          <a href="<?php echo e(url('/login')); ?>" class="login-btn">Guest</a>
      </nav>
    ...
    <section class="home" id="home" style="background-color: #fff1f2;">
      ...
      <div class="home-img">
        <img src="<?php echo e(asset('src/img/rumah-1.jpg')); ?>" alt="Test-1" class="rumah-1 img-fluid" />
      </div>
    </section>
...
<?php /**PATH C:\laragon\www\tubes2\resources\views/landingPage.blade.php ENDPATH**/ ?>